...
INSTANTIATE_TEST_CASE_P(RFC7230, StartLineTest, testing::ValuesIn(std::vector<StartLineFixture>{
...
INSTANTIATE_TEST_CASE_P(RFC7230, HeaderLineTest, testing::ValuesIn(std::vector<HeaderLineFixture>{
